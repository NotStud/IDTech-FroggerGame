...
MENU_BIG = pygame.font.Font('joystix monospace.ttf', 60)
MENU_MED = pygame.font.Font('joystix monospace.ttf', 25)
MENU_SMALL = pygame.font.Font('joystix monospace.ttf', 15)
...
while True:
    ...
    for river in rivers:
        ...
        for alligator in river.alligators:
            ...
            alligator.move()
            if frog.rect.colliderect(alligator.rect):
                frog.reset_position()
